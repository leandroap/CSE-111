...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        ...
        print(f"Name: {name}, birth: {birth_year}, death: {death_year}, age at death: {age}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        husband_age_in_wedding = wedding_year - husband_birth

        wife = people_dict[wife_key]
        wife_birth = wife[BIRTH_YEAR_INDEX]
        wife_name = wife[NAME_INDEX]
        wife_age_in_wedding = wedding_year - wife_birth

        print(f"{husband_name} {husband_age_in_wedding} > " \
              f"{wedding_year} < {wife_name} {wife_age_in_wedding}")
