...
from water_flow import water_column_height, \
    ...
    pressure_loss_from_pipe_reduction, psi_from_kpa
...
def test_psi_from_kpa():
    """
    Verify that the psi_from_kpa function works correctly.
    Parameters: none
    Return: nothing
    """
    assert psi_from_kpa(0) == approx(0, abs=0.001)
    assert psi_from_kpa(1) == approx(0.145038, abs=0.001)
    assert psi_from_kpa(158.579) == approx(23, abs=0.001)
    assert psi_from_kpa(158.7) == approx(23.017489, abs=0.001)
    assert psi_from_kpa(206.843) == approx(30, abs=0.001)
    assert psi_from_kpa(227.527) == approx(33, abs=0.001)
    assert psi_from_kpa(241.317) == approx(35, abs=0.001)
