# File: add_area_code.py
# Author: Leandro Amaral Pereira
# Reference: https://byui-cse.github.io/cse111-course/lesson11/check.html
...
def main():
    try:
        ...
        new_numbers_with_lambda = list(map(add_area_code_lambda, phone_numbers))

        print(new_numbers_with_lambda)
